...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '5aa45c33c58a4bda9d39b6675085fea3',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '时间，地点，人物，事件，过程',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '生活简史', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sitexa.top', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备23789024', // 备案号 闽ICP备XXXXXXX
